...
template: home
description: This document details the policies and procedures of 801 Labs, approved by the Board of Directors on the recorded date.
---
...
* Mine cryptocurrency or otherwise use the internet or power for unauthorised purposes
...
Minors are welcome at 801 Labs, but must be accompanied by a guardian who is at least 18 years old. The guardian is responsible for:

1. The minor's actions and messes.
2. The minor's health.
3. The minor's interactions with other individuals.
4. The minor's dismissal from the hackerspace in the event if neccisary.

## Animals

801 Labs is not allowing animals/pets of any kind. Service Animal(s) trained to do a specific task or set of tasks for you are exempt from this rule, however, ESAs (Emotional Support Animals) do not qualify.
...
* Contact the Board, as a whole ([board@801labs.org](mailto:board@801labs.org))
