        ...
        <div className="bg-contact bg-no-repeat bg-navy-800 text-white">
            <div className="container-1400 mx-auto px-5 py-32 space-y-20 lg:space-y-0 lg:flex">
                <div className="lg:order-last lg:w-2/3">
                    ...
                    <iframe src="https://discord.com/widget?id=690230523615772736&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
                </div>
