...
const Post = (props) => (
    <Layout>
        <Meta
            ...
            image={props.cover}
        />
        <Hero title="801 Labs Research Portal" hLevel={2} />
        <div className="container-1400 mx-auto px-5 py-20 md:flex md:space-x-20">
            <aside className="hidden md:block md:w-1/4">
                <Tags tags={props.allTags} path="/research-portal/tag" />
            </aside>
...
export async function getStaticProps({params}) {
    ...
    const post = research.getPostBySlug(params.slug)
